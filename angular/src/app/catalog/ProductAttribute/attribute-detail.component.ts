...
import { ManufacturerInListDto, ManufacturersService } from '@proxy/admin/manufacturers';
import { ProductAttributeDto, ProductAttributesService } from '@proxy/admin/product-attributes';
import { ProductCategoriesService, ProductCategoryInListDto } from '@proxy/admin/product-categories';
import { ProductDto, ProductsService } from '@proxy/admin/products';
import { attributeTypeOptions } from '@proxy/product-attributes';
...
initFormData(){
  ...
  private buildForm() {
    this.form = this.fb.group({
      label: new FormControl(this.selectedEntity.label || null, Validators.compose([Validators.required, Validators.maxLength(50)])),
