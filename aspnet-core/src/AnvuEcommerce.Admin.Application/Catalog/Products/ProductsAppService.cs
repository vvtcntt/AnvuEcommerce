...
{
    [Authorize(AnvuEcommercePermissions.Product.Default, Policy = "AdminOnly")]
        ...
        IProductsAppService
    {
            ...
            : base(repository)
        {
            ...
            GetPolicyName = AnvuEcommercePermissions.Product.Default;
            GetListPolicyName = AnvuEcommercePermissions.Product.Default;
            CreatePolicyName = AnvuEcommercePermissions.Product.Create;
            UpdatePolicyName = AnvuEcommercePermissions.Product.Update;
            DeletePolicyName = AnvuEcommercePermissions.Product.Delete;

        }
        [Authorize(AnvuEcommercePermissions.Product.Create)]
        ...
        public override async Task<ProductDto> CreateAsync(CreateUpdateProductDto input)
        {
            var product = await _productManager.CreateAsync(
                ...
                ,input.Slug, input.ProductType,input.SKU,input.SortOrder,input.Visibility,input.IsActive,
        ...
        [Authorize(AnvuEcommercePermissions.Product.Update)]

        public override async Task<ProductDto> UpdateAsync(Guid id, CreateUpdateProductDto input)
        {
            var product = await Repository.GetAsync(id);
            if (product == null)
                throw new BusinessException(AnvuEcommerceDomainErrorCodes.ProductIsNotExists);
        ...
        [Authorize(AnvuEcommercePermissions.Product.Delete)]
        ...
        [Authorize(AnvuEcommercePermissions.Product.Default)]
        ...
        public async Task<ProductAttributeValueDto> AddProductAttributeAsync(AddUpdateProductAttributeDto input)
        {
            ...
            if (attribute == null)
                throw new BusinessException(AnvuEcommerceDomainErrorCodes.ProductAttributeIdIsNotExists);
            ...
            switch (attribute.DataType)
            {
                case AttributeType.Date:
                    ...
                    {
                        throw new BusinessException(AnvuEcommerceDomainErrorCodes.ProductAttributeValueIsNotValid);
                    }
