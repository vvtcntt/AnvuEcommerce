using AnvuEcommerce.Configurations.Inventories;
using AnvuEcommerce.Configurations.InventoryTickets;
using AnvuEcommerce.Configurations.Manufacturers;
using AnvuEcommerce.Configurations.Orders;
using AnvuEcommerce.Configurations.ProductAttributes;
...
public class AnvuEcommerceDbContext :
    AbpDbContext<AnvuEcommerceDbContext>,
    IIdentityDbContext,
    ITenantManagementDbContext
{
    ...
    public AnvuEcommerceDbContext(DbContextOptions<AnvuEcommerceDbContext> options)
        : base(options)
    {
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        //{
        //    b.ToTable(AnvuEcommerceConsts.DbTablePrefix + "YourEntities", AnvuEcommerceConsts.DbSchema);
